...
<!--                                                <small class="pull-right time"><i class="fa fa-clock-o"></i>{{message.timestamp}}</small>-->
...
<!--    },-->
<!--    mounted() {-->
<!--        // console.log('Component mounted. Twello' );-->
<!--    },-->
<!--    methods: {-->
<!--        selectChannel(channel) {-->
<!--            let channelSid = channel.sid;-->
<!--            let selectedChannel = this.tc.channelArray.filter(function(channel) {-->
...
<!--        },-->
<!--        notify(message) {-->
<!--            let row = $('<div>').addClass('col-md-12');-->
